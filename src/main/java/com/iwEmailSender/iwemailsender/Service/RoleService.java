...
public class RoleService {
    ...
    public void deleteRole(Long id){
        if(roleRepository.existsById(id)){
            Role role =roleRepository.findById(id).orElseThrow(()->new ResourceNotFoundException("The role with that id doesn't exist in Database!"));
            role.getList_of_accounts().clear();
